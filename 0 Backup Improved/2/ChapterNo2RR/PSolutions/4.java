...
4.- The intersection method computes the intersection of two rectangles—that is, the rectangle that would be formed by two overlapping rectangles if they were drawn. Write a program IntersectionPrinter that constructs two rectangle objects, prints them and then prints the rectangle object that describes the intersection.
