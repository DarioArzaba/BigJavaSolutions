...
11.- Repeat the previous problem, but now write a graphical application that shows the line 
	and the points. Draw each point as a tiny circle. 
	Use the drawString method to draw each distance next to the point, 
	using calls g2.drawString("Distance: " + distance, p.getX(), p.getY());
...
class drawComponentLinePoints extends JComponent {
...
public class LineDistanceViewer {
	...
	public static void main(String[] args) {
		...
		drawComponentLinePoints drawComp = new drawComponentLinePoints();
		window.add(drawComp);
