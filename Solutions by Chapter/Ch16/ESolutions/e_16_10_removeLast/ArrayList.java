...
public class ArrayList
{
    ...
    /**
     * Throws an IndexOutOfBoundException if the checked index is out of bounds.
     *
     ...
     *
     * @param pos        the position
     * @param newElement newElement the element to add
     */
    ...
    /**
     * Shrinks the elements array by 50% if it is less than 25% full.
     */
