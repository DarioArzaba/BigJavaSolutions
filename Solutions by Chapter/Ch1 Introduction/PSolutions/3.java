...
3.- The value of Pi can be computed according to the Leibniz formula for Pi. Write an algorithm to compute Pi. Because the formula is an infinite series and an algorithm must stop after a finite number of steps, you should stop when you have the result determined to six significant digits.
